...
from MEA.common.config import CANONICAL_MEA_WEIGHT_FRACTION, PLOT_ROOT, REPO_ROOT
...
from MEA.nine_species.chemistry import equilibrium_log_constants, initial_all_species_mole_fractions, reaction_matrix


SPECIES_INDEX = {name: idx for idx, name in enumerate(SPECIES)}
FIT_DATASET_DIR = REPO_ROOT / "data" / "epcsaft_datasets" / "MEA_CO2_H2O_ionic_fit"
OUT_DIR = REPO_ROOT / "out" / "epcsaft" / "ionic_regression"
IONIC_PLOT_ROOT = PLOT_ROOT / "epcsaft_ionic"
