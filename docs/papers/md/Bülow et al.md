...
\caption{Table 1. ePC-SAFT Pure-Component Parameters for the Solvents and Sour Gases ${ }^{\boldsymbol{a}}$}
\begin{tabular}{|l|l|l|l|l|l|}
\hline parameter & $\mathrm{H}_{2} \mathrm{O}$ & MDEA & sulfolane & $\mathrm{CO}_{2}$ & $\mathbf{H}_{\mathbf{2}} \mathbf{S}$ \\
\hline $m_{\mathrm{i}}^{\text {seg }}$ & 1.2046 & 3.6750 & 2.7894 & 2.0729 & 1.6686 \\
\hline $\sigma / \AA$ & $b$ & 3.5630 & 3.7020 & 2.7852 & 3.0349 \\
\hline $u_{i} / k_{\mathrm{B}} / \mathrm{K}$ & 353.94 & 228.71 & 436.47 & 169.21 & 229.00 \\
\hline $N^{\text {assoc }}$ & 1:1 & 2:2 & 1:1 & 1:1 & \\
\hline $\frac{\varepsilon^{\mathrm{A}_{\mathrm{i}} \mathrm{B}_{\mathrm{i}}}}{k_{B}} / \mathrm{K}$ & 2425.6 & 2046.6 & 0 & 0 & \\
\hline $\kappa^{\mathrm{A}_{\mathrm{i}} \mathrm{B}_{\mathrm{i}}}$ & 0.045 & 0.1238 & 0.045 & 0.045 & \\
\hline Ref & 30 & 24 & This work & 38 & 23 \\
\hline
\end{tabular}
\end{table}
...
\begin{table}
\captionsetup{labelformat=empty}
\caption{Table 2. ePC-SAFT Pure-Component Parameters for the Charged Species Including the Ions of the IL}
\begin{tabular}{|l|l|l|l|l|l|}
\hline ion & $m_{i}^{\text {seg }}$ & $\sigma / \AA$ & $u_{i} / k_{\mathrm{B}} / \mathrm{K}$ & $z_{i}$ & ref \\
\hline $\mathrm{H}^{+}$ & 1 & 3.4654 & 500.00 & +1 & 26 \\
\hline $\mathrm{OH}^{-}$ & 1 & 2.0177 & 650.00 & -1 & 26 \\
\hline $\mathrm{HCO}_{3}{ }^{-}$ & 1 & 2.9296 & 70.00 & -1 & 26 \\
\hline $\mathrm{CO}_{3}{ }^{2-}$ & 1 & 2.4422 & 249.26 & -2 & 26 \\
\hline $\mathrm{HS}^{-}$ & 1 & 3.0349 & 229.00 & -1 & 24 \\
\hline $\mathrm{MDEAH}^{+}$ & 1 & 3.5630 & 228.71 & +1 & 22 \\
\hline $\left[\mathrm{C}_{4} \mathrm{mim}\right]^{+}$ & 2.4805 & 3.6371 & 218.14 & +1 & 39 \\
\hline $[\mathrm{AC}]^{-}$ & 3.7266 & 3.5605 & 533.11 & -1 & 40 \\
\hline
\end{tabular}
\end{table}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/ab722c49-d22f-4bae-b719-9d92d8fdb4fd-05.jpg?height=323&width=430&top_left_y=235&top_left_x=1327}
\captionsetup{labelformat=empty}
\caption{Figure 1. $P$, $x$-diagram of the binary system sulfolane $+\mathrm{CO}_{2}$ at four temperatures varying from 298 to 403 K . Lines are ePC-SAFT correlations; symbols are experimental data from Jou et al. ${ }^{41} k_{i j}=$ 0.055 .}
\end{figure}

\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/ab722c49-d22f-4bae-b719-9d92d8fdb4fd-05.jpg?height=327&width=430&top_left_y=759&top_left_x=1327}
\captionsetup{labelformat=empty}
\caption{Figure 2. $P$, $x$-diagram of the binary system sulfolane $+\mathrm{H}_{2} \mathrm{~S}$ at four temperatures varying from 298 to 403 K . Lines are ePC-SAFT predictions; symbols are experimental data from Jou et al. ${ }^{41}$}
\end{figure}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/ab722c49-d22f-4bae-b719-9d92d8fdb4fd-05.jpg?height=330&width=430&top_left_y=1480&top_left_x=1327}
\captionsetup{labelformat=empty}
\caption{Figure 3. $P$, $x$-diagram of the binary system sulfolane + water at five temperatures varying from 298 to 323 K . Lines are ePC-SAFT modeling results with induced association between sulfolane and water; symbols are experimental data from Tommila et al. ${ }^{43} k_{i j}=$ 0.015 .}
\end{figure}
...
\begin{table}
\captionsetup{labelformat=empty}
\caption{Table 3. Parameters for the Calculation of $k_{i j}$ via eq $26{ }^{a}$}
\begin{tabular}{|l|l|l|l|l|l|}
\hline pairs & $k_{i j, a}$ & $k_{i j, T}$ & $k_{i j, T^{2}}$ & $k_{i j, T^{3}}$ & ref \\
\hline water-MDEA & -0.118 & $-7.5910^{-4}$ & $-1.3210^{-5}$ & $1.2510^{-7}$ & this work \\
\hline water- $\mathrm{CO}_{2}$ & $-2.110^{-3}$ & $4.5310^{-4}$ & 0 & 0 & this work \\
\hline water- $\mathrm{H}^{+}$ & 0.25 & 0 & 0 & 0 & 31 \\
\hline water $-\mathrm{OH}^{-}$ & -0.25 & 0 & 0 & 0 & 31 \\
\hline water- $\mathrm{CO}_{3}^{2-}$ & -0.25 & 0 & 0 & 0 & 31 \\
\hline sulfolane-water & 0.015 & 0 & 0 & 0 & this work \\
\hline sulfolane- $\mathrm{CO}_{2}$ & 0.055 & 0 & 0 & 0 & this work \\
\hline
\end{tabular}
\end{table}

\footnotetext{
${ }^{a} k_{i j}$ Calculated this way are valid in the temperature range $293-413 \mathrm{~K}$. Only valid with the pure-component parameters in Tables 1 and 2.
}
pressure in regions of high sulfolane mole fractions. For an accurate modeling of the VLE, a temperature-independent $k_{i j}=$ 0.015 was adjusted.

\section*{Predicting VLE for Sour-Gas Absorption in Aqueous}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/ab722c49-d22f-4bae-b719-9d92d8fdb4fd-06.jpg?height=314&width=430&top_left_y=772&top_left_x=410}
\captionsetup{labelformat=empty}
\caption{Figure 4. Partial pressure of $\mathrm{CO}_{2}$ vs sour-gas loading in the system water + MDEA $(19 \mathrm{wt} \%)+\mathrm{CO}_{2}$. Lines are predictions with ePCSAFT using parameters from Tables 1-3; symbols are experimental data (points: 313 K , squares: 333 K , triangles: 373 K , stars: 393 K ). ${ }^{10}$ ARD\% are listed in Table S3 in the SI.}
\end{figure}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/ab722c49-d22f-4bae-b719-9d92d8fdb4fd-06.jpg?height=318&width=430&top_left_y=2109&top_left_x=410}
\captionsetup{labelformat=empty}
\caption{Figure 5. Partial pressure of $\mathrm{H}_{2} \mathrm{~S}$ vs sour-gas loading in the system water + MDEA $(19 \mathrm{wt} \%)+\mathrm{H}_{2} \mathrm{~S}$. Lines are predictions with ePCSAFT using parameters from Tables 1-3; symbols are experimental data (points: 313 K , squares: 333 K , triangles: 373 K , stars: 393 K ). ${ }^{10}$ ARD\% are listed in Table S4 in the SI.}
\end{figure}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/ab722c49-d22f-4bae-b719-9d92d8fdb4fd-06.jpg?height=317&width=430&top_left_y=1036&top_left_x=1327}
\captionsetup{labelformat=empty}
\caption{Figure 6. Partial pressure of $\mathrm{H}_{2} \mathrm{~S}$ vs sour-gas loading in the system water + MDEA $(20.9 \mathrm{wt} \%)+$ sulfolane $(30.5 \mathrm{wt} \%)+\mathrm{H}_{2} \mathrm{~S}$. Lines are predictions with ePC-SAFT using parameters from Tables 1-3; symbols are experimental data (stars: 373 K , triangles: 313 K ). ${ }^{41} \operatorname{ARD}(373 \mathrm{~K})=27.26 \% ; \operatorname{ARD}(313 \mathrm{~K})=13.15 \%$.}
\end{figure}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/ab722c49-d22f-4bae-b719-9d92d8fdb4fd-07.jpg?height=312&width=430&top_left_y=235&top_left_x=412}
\captionsetup{labelformat=empty}
\caption{Figure 7. Partial pressure of $\mathrm{CO}_{2}$ vs sour-gas loading in the system water + MDEA ( $20.9 \mathrm{wt} \%$ ) + sulfolane ( $30.5 \mathrm{wt} \%$ ) + $\mathrm{CO}_{2}$. Lines are predictions with ePC-SAFT using parameters from Tables 1-3; symbols are experimental data (stars: 373 K , triangles: 313 K ). ${ }^{41}$ ARD $\%(373 \mathrm{~K})=36.50 \%$; ARD $\%(313 \mathrm{~K})=35.62 \%$.}
\end{figure}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/ab722c49-d22f-4bae-b719-9d92d8fdb4fd-07.jpg?height=339&width=1477&top_left_y=2162&top_left_x=346}
\captionsetup{labelformat=empty}
\caption{Figure 8. Partial pressure of $\mathrm{CO}_{2}$ vs sour-gas loading in the system water $+\mathrm{MDEA}+$ sulfolane $+\mathrm{CO}_{2}$ at $T=328 \mathrm{~K}$. Lines are predictions with ePCSAFT using parameters from Tables $1-3$; symbols are experimental data: (a) MDEA $40 \mathrm{wt} \%$, sulfolane $10 \mathrm{wt} \%$, (b) MDEA $30 \mathrm{wt} \%$, sulfolane 20 $\mathrm{wt} \%$, (c) MDEA $40 \mathrm{wt} \%$, sulfolane $20 \mathrm{wt} \%$. ARD\%: $(\mathrm{a})=26.38 \%$, $(\mathrm{b})=27.34 \%$, $(\mathrm{c})=19.26 \%$.}
\end{figure}

\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/ab722c49-d22f-4bae-b719-9d92d8fdb4fd-08.jpg?height=327&width=430&top_left_y=235&top_left_x=412}
\captionsetup{labelformat=empty}
\caption{Figure 9. Partial pressure of $\mathrm{CO}_{2}$ vs sour-gas loading in the system water $+\operatorname{MDEA}(30 \mathrm{wt} \%)+\left[\mathrm{C}_{4} \operatorname{mim}\right][\mathrm{Ac}](10 \mathrm{wt} \%)+\mathrm{CO}_{2}$ (stars) and in the system water + MDEA (30 wt \%) for comparison (triangles). Lines are predictions with ePC-SAFT using parameters from Tables 1-3; symbols are experimental data. ${ }^{45}$ ARD\% (MDEA + $\mathrm{IL})=32.44 \%$; ARD\% (MDEA) $=32.68 \%$.}
\end{figure}
