...
GitHub source: https://github.com/tannerpolley/MEA-Thermodynamics/issues/10

## Problem statement

Provide the final submit-or-hold gate for the fixed-parameter evaluation
manuscript without treating future coupled regression as an executed or
mandatory result.
...
of the fixed-parameter evaluation paper.
