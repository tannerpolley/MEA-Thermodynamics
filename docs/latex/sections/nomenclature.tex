\section{Nomenclature and Symbols}\label{sec:nomenclature}
\begin{table}
    \centering
    \caption{Primary symbols used in this manuscript.}
    ...
    \begin{tabularx}{\linewidth}{lX}
        ...
        \(y_i^{\mathrm{true}}\) & True-species mole fraction of species \(i\) after speciation solve \\
        \(\gamma_i\) & Species activity coefficient from ePC-SAFT \\
        \(\phi_i\) & Fugacity coefficient from ePC-SAFT \\
        \(\kappa_{ij}\) & Binary interaction parameter between species \(i\) and \(j\) \\
