...
CURATED_REQUIREMENTS = {
    ...
    "analyses/phase1/smith_missen_baseline/results": [
        ...
        *plot_bundle("phase1_speciation_vs_loading"),
        "phase1_speciation_vs_loading_plot_data.csv",
    ],
    ...
    "analyses/phase2/activity_epcsaft/results": [
        ...
        *plot_bundle("phase2_speciation_activity_plot"),
        "phase2_speciation_activity_plot_plot_data.csv",
    ],
