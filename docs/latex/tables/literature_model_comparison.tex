\begin{table*}
    ...
    \begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{2.2cm}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
        ...
        Present study & \MEA--\HtwoO--\COtwo SSM+DS modified-Born ePC-SAFT & Nine-species explicit ionic basis with \MEAH/\MEACOO carbamate chemistry, SSM+DS Born terms, and concentration-dependent permittivity & Seven \MEAH/\MEACOO parameters fitted to eight NMR states & 161 pressure records and 66 additional NMR states \\
        \bottomrule
    \end{tabularx}
\end{table*}
