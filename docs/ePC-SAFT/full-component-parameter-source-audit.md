...
| HCO3- | `Held2014`; `Figiel2025`; `Uyan et al.`; `Wangler et al.`; trace-carbonate Born full-data seed scan | Analog / diagnostic set with direct trace check | `s,e,d_born,dielc,f_solv,z,MW,kij` | Promoted row is `m=1`, `s=2.9296`, `e=70`, `d_born=3`, `dielc=8`, `f_solv=1`, `z=-1`, `MW=0.0610168`; promoted `water-HCO3- k_ij=0.0` from Held/Uyan; full-data seed scan retained `d_born=3.0` | Substantial candidates worsen the real carbonate-speciation objective: `4.5/4.5` gives norm `0.83757`, `6.5/7.5` gives `1.06138`, and `1.05/1.05` gives `1.91350` versus `0.70211` at `3.0/3.0`; pressure-weighted global optimization remains a later calibration step | `docs/papers/md/Uyan et al.md` Tables 4-5; Held 2014 Table 2 through the ePC-SAFT source digest; `analyses/epcsaft_ionic_regression/results/trace_carbonate_born_regression`; current `any_solvent.csv`; current `k_ij.csv` |
| CO3^2- | `Held2014`; `Figiel2025`; `Uyan et al.`; `Wangler et al.`; trace-carbonate Born full-data seed scan | Analog / diagnostic set with direct trace check | `s,e,d_born,dielc,f_solv,z,MW,kij` | Promoted row is `m=1`, `s=2.4422`, `e=249.26`, `d_born=3`, `dielc=8`, `f_solv=1`, `z=-2`, `MW=0.06001`; promoted `water-CO3^2- k_ij=-0.25` from Held/Uyan; full-data seed scan retained `d_born=3.0` | Substantial candidates worsen the real carbonate-speciation objective: `4.5/4.5` gives norm `0.83757`, `6.5/7.5` gives `1.06138`, and `1.05/1.05` gives `1.91350` versus `0.70211` at `3.0/3.0`; pressure-weighted global optimization remains a later calibration step | `docs/papers/md/Uyan et al.md` Tables 4-5; Held 2014 Table 2 through the ePC-SAFT source digest; `analyses/epcsaft_ionic_regression/results/trace_carbonate_born_regression`; current `any_solvent.csv`; current `k_ij.csv` |
