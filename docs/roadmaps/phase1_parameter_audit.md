...
- `verified`: The retained repo neutral-parity workflow still uses the inherited `MEA 2B / H2O 2B` molecular row and `k_ij = -0.1800` from [src/MEA/epcsaft_neutral/parameters.py](src/MEA/epcsaft_neutral/parameters.py).
...
- Retained repo continuity choice:
  the inherited molecular row and neutral-parity `k_ij` in [src/MEA/epcsaft_neutral/parameters.py](src/MEA/epcsaft_neutral/parameters.py).
...
- Parameter inventory: [phase1_parameter_provenance.csv](data/reference/MEA/manifests/phase1_parameter_provenance.csv)
- Phase 1 analysis parameter table: [phase1_parameter_table.csv](analyses/phase1_smith_missen_baseline/results/phase1_parameter_table.csv)
